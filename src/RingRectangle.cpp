...
RingRectangle::RingRectangle(QQuickItem *parent) : QQuickPaintedItem(parent) {
    color(QColor(255, 255, 255, 255));
    radius({0, 0, 0, 0});
    connect(this, &RingRectangle::colorChanged, this, [=] { update(); });
    connect(this, &RingRectangle::radiusChanged, this, [=] { update(); });
}

void RingRectangle::paint(QPainter *painter) {
    painter->save();
