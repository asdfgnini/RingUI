...
RingColors::RingColors(QObject* parent):QObject{parent}
{
    ...
    auto yellow = new RingAccentColor(this);
    ...
    auto orange = new RingAccentColor(this);
    ...
    auto red = new RingAccentColor(this);
    ...
    auto magenta = new RingAccentColor(this);
    ...
    auto purple = new RingAccentColor(this);
    ...
    auto blue = new RingAccentColor(this);
    ...
    auto teal = new RingAccentColor(this);
    ...
    auto green = new RingAccentColor(this);
...
[[maybe_unused]] RingAccentColor *RingColors::createAccentColor(const QColor &primaryColor) {
    auto accentColor = new RingAccentColor(this);
    accentColor->normal(primaryColor);
    accentColor->dark(RingTools::getInstance()->withOpacity(primaryColor, 0.9));
    accentColor->light(RingTools::getInstance()->withOpacity(primaryColor, 0.9));
    accentColor->darker(RingTools::getInstance()->withOpacity(accentColor->dark(), 0.8));
    accentColor->lighter(RingTools::getInstance()->withOpacity(accentColor->light(), 0.8));
    accentColor->darkest(RingTools::getInstance()->withOpacity(accentColor->darker(), 0.7));
    accentColor->lightest(RingTools::getInstance()->withOpacity(accentColor->lighter(), 0.7));
    return accentColor;
}
