...
Item {
    ...
    Item{
        ...
        property bool isCompact: d.displayMode === RingNavigationViewType.Compact
        property bool isMinimal: d.displayMode === RingNavigationViewType.Minimal
        property bool isCompactAndPanel: d.displayMode === RingNavigationViewType.Compact && d.enableNavigationPanel
        property bool isCompactAndNotPanel:d.displayMode === RingNavigationViewType.Compact && !d.enableNavigationPanel
        property bool isMinimalAndPanel: d.displayMode === RingNavigationViewType.Minimal && d.enableNavigationPanel
        property color itemDisableColor: RingTheme.dark ? Qt.rgba(131/255,131/255,131/255,1) : Qt.rgba(160/255,160/255,160/255,1)
    ...
    Component.onCompleted: {
        d.displayMode = Qt.binding(function(){
            if(control.displayMode !==RingNavigationViewType.Auto){
                return control.displayMode
            }
            if(control.width<=700){
                return RingNavigationViewType.Minimal
            }else if(control.width<=900){
                return RingNavigationViewType.Compact
            }else{
                return RingNavigationViewType.Open
            }
        })
    ...
    Connections{
        ...
        function onDisplayModeChanged(){
            if(d.displayMode === RingNavigationViewType.Compact){
                collapseAll()
            }
    ...
    Component{
        ...
        Item{
            ...
            Behavior on height {
                enabled: RingTheme.animationEnabled && d.animDisabled
                NumberAnimation{
                    duration: 83
                }
            }
                ...
                Rectangle{
                    ...
                    RingIcon{
                        ...
                        color: {
                            ...
                            return RingTheme.dark ? "#FFFFFF" : "#000000"
                        }
                    }
                    color: {
                        if(!item_control.enabled){
                            return RingTheme.itemNormalColor
                        }
                        if(nav_list.currentIndex === _idx&&type===0){
                            return RingTheme.itemCheckColor
                        }
                        if(item_control.hovered){
                            return RingTheme.itemHoverColor
                        }
                        return RingTheme.itemNormalColor
                    }
                    Component{
                    ...
                    RingText{
                        ...
                        color:{
                            ...
                            if(item_control.pressed){
                                return RingTheme.dark ? RingColors.Grey80 : RingColors.Grey120
                            }
                            return RingTheme.dark ? RingColors.White : RingColors.Grey220
                        }
                    }
                    RingLoader{
                        id:item_edit_loader
        ...
        RowLayout{
            ...
            RingIconButton{
                ...
                onClicked: {
                    ...
                    if(pageMode === RingNavigationViewType.Stack){
                    ...
                    }else if(pageMode === RingNavigationViewType.NoStack){
    ...
    Rectangle{
        ...
        border.color: RingTheme.dark ? Qt.rgba(45/255,45/255,45/255,1) : Qt.rgba(226/255,230/255,234/255,1)
        border.width:  d.isMinimal || d.isCompactAndPanel ? 1 : 0
        color: {
            if(d.isMinimal || d.enableNavigationPanel){
                return RingTheme.dark ? Qt.rgba(61/255,61/255,61/255,1) : Qt.rgba(243/255,243/255,243/255,1)
            }
            return "transparent"
        }
        RingShadow{
        ...
        visible: {
            if(d.displayMode !== RingNavigationViewType.Minimal)
                return true
        ...
        Flickable{
            ...
            ListView{
                ...
                model:d.handleItems()
                boundsBehavior: ListView.StopAtBounds
                highlightMoveDuration: RingTheme.animationEnabled && d.animDisabled ? 167 : 0
                highlight: Item{
                    clip: true
                    Rectangle{
                        height: 18
                ...
                delegate: RingLoader{
                    ...
                    sourceComponent: {
                        if(model === null || !model)
                            return undefined
                        if(modelData instanceof RingPaneItem){
                            return com_panel_item
                        }
                        if(modelData instanceof RingPaneItemHeader){
                            return com_panel_item_header
                        }
                        if(modelData instanceof RingPaneItemSeparator){
                            return com_panel_item_separatorr
                        }
                        if(modelData instanceof RingPaneItemExpander){
                            return com_panel_item_expander
                        }
                        if(modelData instanceof RingPaneItemEmpty){
    ...
    Popup{
        ...
        background: RingRectangle{
            implicitWidth: 180
            radius: [4,4,4,4]
            RingShadow{
                radius: 4
            }
            color: RingTheme.dark ? Qt.rgba(51/255,48/255,48/255,1) : Qt.rgba(248/255,250/255,253/255,1)
        }
