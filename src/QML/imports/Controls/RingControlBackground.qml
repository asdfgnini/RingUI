...
Item{
    ...
    property color color: RingTheme.dark ? Qt.rgba(42/255,42/255,42/255,1) : Qt.rgba(254/255,254/255,254/255,1)
    ...
    Rectangle{
        ...
        visible: false
        border.color: RingTheme.dark ? Qt.rgba(48/255,48/255,48/255,1) : Qt.rgba(188/255,188/255,188/255,1)
    }
    Rectangle{
        id:rect_border
        anchors.fill: parent
