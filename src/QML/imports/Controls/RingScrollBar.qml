...
T.ScrollBar {
    ...
    property color color : RingTheme.dark ? Qt.rgba(159/255,159/255,159/255,1) : Qt.rgba(138/255,138/255,138/255,1)
    property color pressedColor: RingTheme.dark ? Qt.darker(color,1.2) : Qt.lighter(color,1.2)
    ...
    background: Rectangle{
        id:back_rect
        radius: 5
        color:RingTheme.dark ? Qt.rgba(44/255,44/255,44/255,1) : Qt.rgba(255/255,255/255,255/255,1)
        opacity:{
            if(vertical){
    ...
    RingIconButton{
        ...
        iconSource: RingIcons.CaretLeftSolid8
        onClicked: {
            control.decrease()
        }
    }
    RingIconButton{
        ...
        visible: control.horizontal
        iconSource: RingIcons.CaretRightSolid8
        onClicked: {
            control.increase()
        }
    }
    RingIconButton{
        ...
        iconSource: RingIcons.CaretUpSolid8
        onClicked: {
            control.decrease()
        }
    }
    RingIconButton{
        ...
        visible: control.vertical
        iconSource: RingIcons.CaretDownSolid8
        onClicked: {
            control.increase()
        }
    }
